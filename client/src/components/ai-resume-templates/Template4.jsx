...
//  );
 ...
 const ResumeEditor = () => {
   const [resumeData, setResumeData] = useState({
     name: "ADITYA TIWARY",
     role: "Laboratory Technician | Specimen Analysis | Quality Control",
     phone: "+1-(234)-555-1234",
     email: "info@enhancv.com",
     linkedin: "linkedin.com",
     location: "Dallas, Texas",
     summary:
       "Passionate Lab Technician with 3+ years' experience in clinical lab settings. Expert in conducting specimen testing and quality control with a proven track record of improving sample throughput. Excels in delivering accurate results in fast-paced environments.",
     experience: [
       {
         ...
         accomplishment:
           "• Streamlined specimen analysis process, reducing testing turnaround time by 20%.\n" +
           "• Implemented rigorous quality control procedures that decreased sample contamination by 15%.\n" +
           "• Introduced a new inventory management system for laboratory supplies, reducing waste by 10%.\n" +
           "• Trained 5 new technicians in correct testing protocols and equipment maintenance.\n" +
           "• Authored a departmental manual on best practices, enhancing team efficiency.\n" +
           "• Conducted over 1,000 clinical specimen tests, maintaining a 99% accuracy rate.",
       },
       {
         title: "Biological Technician",
         companyName: "BioReference Laboratories",
         date: "02/2018 - 05/2020",
         companyLocation: "Plano, TX",
         accomplishment:
           "• Improved report documentation workflow, resulting in a 25% increase in productivity.\n" +
           "• Assisted in validating new assay methods, contributing to a 30% expansion of testing offerings.\n" +
           "• Consistently met daily targets by processing an average of 80-100 specimens.\n" +
           "• Collaborated in a project to optimize automated pipetting techniques.\n" +
           "• Managed equipment maintenance schedules, ensuring 98% uptime.",
       },
       {
         title: "Lab Assistant",
         companyName: "UT Southwestern Medical Center",
         date: "11/2015 - 01/2018",
         companyLocation: "Dallas, TX",
         accomplishment:
           "• Participated in a team that increased the laboratory's testing capacity by 35%.\n" +
           "• Maintained meticulous records for over 500 chemical and biological reagents.\n" +
           "• Successfully completed critical equipment preventative maintenance 100% on schedule.\n" +
           "• Assisted in research that led to 2 publications in peer-reviewed journals.",
       },
     ],
     education: [
       {
         degree: "Master of Science in Clinical Laboratory Sciences",
     ...
     achievements: [
       {
         title: "Lead Project on Test Method Validation",
         description:
           "Spearheaded the validation of new analytical test methods, increasing laboratory test menus by 30% within one year.",
       },
       {
         title: "Publication Contributor",
         description:
           "Contributed research findings to 2 scholarly articles, broadening the scientific community's understanding of endocrinology markers.",
       },
       {
         title: "Reduced Waste in Inventory",
         description:
           "Implemented a lean inventory system that cut supply waste by over 10%, saving the company $5,000 annually.",
       },
       {
         title: "Recognized Employee Excellence Award",
         description:
           "Earned the 'Outstanding Technician of the Year' award in 2019 for exceptional contributions to team goals and patient care quality.",
       },
     ],
     languages: [
     ...
     skills: [
       { category: "Specimen Analysis", items: ["Specimen Analysis"] },
       { category: "Quality Control", items: ["Quality Control"] },
       {
         category: "Lab Equipment Maintenance",
         items: ["Lab Equipment Maintenance"],
       },
       {
         category: "Laboratory Information Systems",
         items: ["Laboratory Information Systems"],
       },
       { category: "Pipetting", items: ["Pipetting"] },
       { category: "Chemistry", items: ["Chemistry"] },
     ],
     courses: [
       {
     ...
     passions: [
       {
         title: "Advancements in Laboratory Medicine",
         description:
           "Actively seeking out new techniques and technologies to advance efficiency and accuracy in specimen analysis.",
       },
       {
         title: "Community Health Volunteering",
         description:
           "Engage in local health drives providing free testing and consultations, emphasizing the importance of preventive medicine.",
       },
     ],
   });
                       ...
                       {resumeData.experience.map((exp, idx) => (
                         <div key={idx} className="mb-3 sm:mb-4">
                           ...
                           <div
                             ...
                             className="text-xs sm:text-sm text-gray-700 whitespace-pre-line"
                           >
                             {exp.accomplishment}
                           </div>
                           {showButtons && (
